...
SWEP.Primary.Sound 					= Sound ("Weapon_DC17MS.Single");
SWEP.Primary.ReloadSound 			= Sound ("weapons/bf3/rifles.wav");
SWEP.Primary.PenetrationMultiplier 	= 1.25
SWEP.Primary.Damage					= 70.5
...
SWEP.IronSightsPos_8SCOPE = Vector(-4.37, -11, -0)
SWEP.IronSightsAng_8SCOPE = Vector(4, 0, 0)

SWEP.IronSightsPos = Vector(-3.32, -11, .2) //across //close //up&down
...
SWEP.VElements = {
	["e22_v"] = { type = "Model", model = "models/rcremastered/weapons/w_dc-17m_sniper.mdl", bone = "v_e11_reference001", rel = "", pos = Vector(-2, 5.714, 1.557), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/rcremastered/weapons/w_dc-17m_sniper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.909, 0, -4.676), angle = Angle(-12.858, 1.169, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
